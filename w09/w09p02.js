...
async function main() {
    ...
    const textures = {
        ...
        env: await loadTexture(device, "luxo_pxr_campus.hdr.png"),
    };
    ...
    function onReadComplete(device, pipeline) {
        ...
        const group = device.createBindGroup({
            ...
            entries: [
                ...
                // Uncomment this if needed: { binding: 6, resource: { buffer: buffers.light_indices } },
