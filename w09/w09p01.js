...
async function main() {
    ...
    // Get canvas and configure its WebGPU context
    ...
    const textures = {
        ...
        env: await load_texture(device, "luxo_pxr_campus.jpg"), // Load environment texture
    };
    ...
    function onReadComplete(device, pipeline) {
        ...
        buffers.color = device.createBuffer({
            size: g_drawingInfo.materials.length * 32, // 8 floats * 4 bytes
        ...
        const group = device.createBindGroup({
            ...
            entries: [
                ...
                // { binding: 6, resource: { buffer: buffers.light_indices }}, // Uncomment if needed
